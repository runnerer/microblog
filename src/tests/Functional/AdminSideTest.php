...
class AdminSideTest extends BaseTestCase {
    /**
     * @test
     *
     */
    public function getAdminWithoutLogin() {
    ...
    public function loginAndCreatePost() {
        ...
        $response = $this->runApp('POST', '/posts', [
    ...
    public function loginAndEditPost() {
        ...
        $response = $this->runApp('POST', '/posts/11', [
            'title' => 'Test edit post title',
            'text' => 'Test edit post text',
            'image' => 'uploads\images\VrGdbTk.jpeg'
        ]);
